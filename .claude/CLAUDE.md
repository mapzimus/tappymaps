...
- Block 1 (Mobile IIFE) baseline is **34,104 chars** (was 33,371 before the Phase-5 floating-panel zoom API). Arcade/games never touch it; an unexpected size change means an accidental edit.
